...
class LetterBox:
    ...
    def __init__(self, new_shape=(640, 640), auto=False, scaleFill=False, scaleup=True, center=True, stride=32):
        ...
        #print("neww shapeee  is  ",self.new_shape)
        self.auto = auto
    ...
    def __call__(self, labels=None, image=None):
        ...
        #print("444444444444444444 ",self.new_shape)
        new_shape = labels.pop('rect_shape', self.new_shape)
        #print("555555555555555555555555 ",new_shape)
        ...
        #print("new shape isss   ",new_shape)
        dw, dh = new_shape[1] - new_unpad[0], new_shape[0] - new_unpad[1]  # wh padding
        #print("dh and dw are 1111 ",dh," ",dw)
        ...
        #print("dh and dw are ",dh," ",dw)

        if shape[::-1] != new_unpad:  # resize
            #print("resizingggggggggggggggggggg ")
            img = cv2.resize(img, new_unpad, interpolation=cv2.INTER_LINEAR)
        top, bottom = int(round(dh - 0.1)) if self.center else 0, int(round(dh + 0.1))
        left, right = int(round(dw - 0.1)) if self.center else 0, int(round(dw + 0.1))
        #print("initial img shape 22222 ",img.shape)
        img = cv2.copyMakeBorder(img, top, bottom, left, right, cv2.BORDER_CONSTANT,
                                 value=(114, 114, 114))  # add border
        
        #print("initial img shape 333 ",top," ",bottom," ",left," ",right)
        ...
        if len(labels):
            ...
            #print("label img shape ",labels['img'].shape)
            return labels
        else:
            return img

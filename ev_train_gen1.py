...
def main(args,default_cfg_file = "./default.yaml"):
    ...
    net = snn_repvgg.CustomModel(in_channels = args.in_channels ,num_classes = data_info['nc'] ,for_distillation = False,T=1)
    ...
    for epoch in range(current_epoch,args.epoch):
        ...
        for i,batch in train_pbar:
                ...
                if args.distill:
                    ...
                    with torch.no_grad():
                        ...
                        t_preds,t_feature_maps = teacher_net(batch['distill_frame'].to(device, non_blocking=True).float())
                    ...
                    preds,feature_maps,_ = net(batch['img'],sparsity_montior)
        ...
        with torch.no_grad():
            ...
            for i,batch in enumerate(val_pbar):
                ...
                preds,feature_maps,_ = net(batch['img'])

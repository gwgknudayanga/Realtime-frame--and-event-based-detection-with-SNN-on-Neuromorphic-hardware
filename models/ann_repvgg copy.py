...
class CustomModel(nn.Module):
    ...
    def __init__(self,in_channels = 3,num_classes = 20,for_distillation = False):
        ...
        self.layers = nn.Sequential(
            RepVGGBlock(in_channels,4,3,2),
            RepVGGBlock(4,16,3,2),
            Conv(16, 64, kernel_size=3, stride=1, padding=1),
            ...
            Conv(512, 256, kernel_size=3, stride=2, padding=1),
            Conv(256, 128, kernel_size=3, stride=1, padding=1),
            Conv(128, 24, kernel_size=3, stride=1, padding=1),
        )

...
class DetectionValidator:
    ...
    def preprocess(self, batch,normalize = True):
    ...
    def update_metrics(self, preds, batch):
        ...
        for si, pred in enumerate(preds):
            ...
            if len(batch['img'].shape) == 5:
                channel_dim_idx = 2
                ops.scale_boxes(batch['img'][:,si,...].shape[channel_dim_idx:], predn[:, :4], shape,
            ...
            if nl:
                ...
                if len(batch['img'].shape) == 5:
                    ...
                    ops.scale_boxes(batch['img'][:,si,...].shape[channel_dim_idx:], tbox, shape,

...
class CustomModel(nn.Module):
    ...
    def __init__(self,in_channels = 3,num_classes = 20,T=5,distillation_required = False):
        ...
        net = torch.nn.ModuleList([
            ...
            lava_exchange.BlockRepContainer(
                ...
                layer.Conv2d(in_channels, 4, kernel_size=1, padding=(1 - 3//2), stride=2, bias=False),
                lava_exchange.CubaRepLIFNode(**neuron_stride_params,norm1 = lava_exchange.BatchNorm2d(4),norm2 = lava_exchange.BatchNorm2d(4),detach_reset = True),
            ),
            ...
            #layer.Dropout2d(p=0.1), 
             ...
             lava_exchange.BlockRepContainer(
                ...
                layer.Conv2d(4, 16, kernel_size=1, padding=(1 - 3//2), stride=2, bias=False),
                lava_exchange.CubaRepLIFNode(**neuron_stride_params,norm1 = lava_exchange.BatchNorm2d(16),norm2 = lava_exchange.BatchNorm2d(16), detach_reset = True),
            ),
           ...
           lava_exchange.BlockContainer(
            ...
            #lava_exchange.BlockContainer(
            #    layer.Conv2d(128,24, kernel_size=1, padding=0, stride=1, bias=False),
        ...
        if self.distillation_required:
            ...
            self.projection3  = lava_exchange.BlockContainer(
                layer.Conv2d(self.layers[10].synapse.out_channels, self.layers[10].synapse.out_channels,kernel_size=1, padding=0, stride=1, bias=False),
                lava_exchange.CubaLIFNode(**neuron_output_params,norm = None,detach_reset = True),
            )
    ...
    def forward(self, x,sparsity_monitor = None):
        ...
        return detection_output,feature_maps #,None #,for_attention_maps 

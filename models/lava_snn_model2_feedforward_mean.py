...
class SparsityChecker:
    ...
    def append(self, x: torch.tensor) -> None:
        ...
        mean_event_rate = torch.mean(torch.abs(x),axis=0) #hope first axis is time 'T'
...
class CustomModel(nn.Module):
    ...
    def __init__(self,in_channels = 3,num_classes = 20,T=5,distillation_required = False):
        ...
        net = torch.nn.ModuleList([
            ...
            lava_exchange.BlockContainer(
                ...
                lava_exchange.CubaLIFNode(**neuron_stride_params,norm = lava_exchange.Temp(4),detach_reset = True),
            ),
            ...
            #layer.Dropout2d(p=0.1), 
             ...
             lava_exchange.BlockContainer(
                ...
                lava_exchange.CubaLIFNode(**neuron_stride_params,norm = lava_exchange.Temp(16), detach_reset = True),
            ),
            ...
            lava_exchange.BlockContainer(
                ...
                lava_exchange.CubaLIFNode(**neuron_stride_params,norm = lava_exchange.Temp(64),detach_reset = True),
            ),

            lava_exchange.BlockContainer(
                layer.Conv2d(64, 128, kernel_size=3, padding=1, stride=2, bias=False),
                lava_exchange.CubaLIFNode(**neuron_stride_params,norm = lava_exchange.Temp(128),detach_reset = True),
            ),
            ...
            lava_exchange.BlockContainer(
                ...
                lava_exchange.CubaLIFNode(**neuron_stride_params,norm = lava_exchange.Temp(256),detach_reset = True),
            ),
           ...
           lava_exchange.BlockContainer(
                ...
                lava_exchange.CubaLIFNode(**neuron_stride_params,norm = lava_exchange.Temp(512),detach_reset = True),
            ),
            ...
            lava_exchange.BlockContainer(
                ...
                lava_exchange.CubaLIFNode(**neuron_stride_params,norm = lava_exchange.Temp(24), detach_reset = True),
            ),
    ...
    def to_slayer(self):
        ...
        for i in range(self.head_backend.__len__()):
            m = self.head_backend[i]
            if isinstance(m, lava_exchange.BlockContainer):
                ret.append(m.to_lava_block())

...
class SpikeDetect2(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        self.cv2 = nn.ModuleList(
            nn.Sequential(SpikeConv2(x, c2, 3), SpikeConv2(c2, c2, 3), SpikeConvWithoutBN2(c2, 4 * self.reg_max, 1)) for x in ch)

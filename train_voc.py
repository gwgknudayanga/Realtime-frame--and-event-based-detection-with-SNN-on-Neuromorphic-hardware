    ...
    for epoch in range(current_epoch,args.epoch):
        ...
        with torch.no_grad():
            ...
            for i,batch in enumerate(val_pbar):
                ...
                idx = idx.rsplit(".",1)[0]
                img_save_path = "/home/nrthpc/Udaya_stuff/evCIVIL_direct_train/ultralytic_compatible_ANN_SNN_snn_repvgg/visualize_data_folder/model2_voc_img"
                dump_image_with_labels((batch['img']*255.0).to(torch.uint8)[0][0],temp_ann_arr,[192,256],img_save_path,idx,create_histo_frames = False,annotation_format="bbox")
                #visualize end"""
...
def get_args():
    ...
    parser.add_argument("-load",type=str,default="/home/nrthpc/Udaya_stuff/Result_Collector/lava_mini_distilled/voc_img/best.pt")

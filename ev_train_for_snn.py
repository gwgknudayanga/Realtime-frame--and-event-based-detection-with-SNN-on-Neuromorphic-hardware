...
from obd.models import lava_snn_model2_sota,lava_snn_model2 #import CustomModel
from obd.models import snn_repvgg,snn_repvgg_sota
...
def main(args,default_cfg_file = "./default.yaml"):
    ...
    net = snn_repvgg_sota.CustomModel(in_channels = 2,num_classes = 2,for_distillation = True,T=1)

    #net = lava_snn_model2.CustomModel(in_channels = 3,num_classes =2,T=7,distillation_required = False)

    #net = ann_repvgg.CustomModel(in_channels = args.in_channels,num_classes = data_info['nc']) 

    #net = snn_repvgg.CustomModel(in_channels = 2,num_classes = 2,for_distillation = False,T=1)
        ...
        """for i,batch in train_pbar:
                ...
                if args.distill:
                    ...
                    with torch.no_grad():
                        ...
                        t_preds,t_feature_maps,_ = teacher_net(batch['distill_frame'].to(device, non_blocking=True).float())
...
def get_args():
    ...
    parser.add_argument("-load",type=str,default="/home/nrthpc/From_server_ultralytic_compatible_ANN_SNN_event_based_to_slayer/checkpoints/SOTA_ANCHORFREE/snn/gen1/best.pt")

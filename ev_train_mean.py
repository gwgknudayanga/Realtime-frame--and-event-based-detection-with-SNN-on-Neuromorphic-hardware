...
from obd.models import lava_snn_model2_sota,lava_snn_model2,snn_repvgg_sota,lava_snn_model2_feedforward,lava_snn_model2_feedforward_mean, lava_snn_model2_sota_mean #impot CustomModel
...
def main(args,default_cfg_file = "./default.yaml"):
    ...
    net = lava_snn_model2_sota_mean.CustomModel(in_channels=args.in_channels,num_classes=data_info['nc'],T=7,distillation_required=False)
    ...
    #net.detect.stride 
    net.stride = torch.tensor([temp_height / x.shape[-2] for x in net(torch.zeros(1,args.in_channels,temp_height,temp_width).cuda())[0]])
    ...
    #load_model_for_available_keys(net,torch.load(args.load),device)
    ...
    train_loader = get_dataloader(args,mode ="train",stridee = net.stride)
...
def get_args():
    ...
    #parser.add_argument("-load",type=str,default="/home/nrthpc/Udaya_stuff/From_server_ultralytic_compatible_ANN_SNN_event_based_to_slayer/checkpoints/SOTA_ANCHORFREE/evCIVIL_lava/feedforward_best.pt")
    #parser.add_argument("-load",type=str,default="/home/nrthpc/Udaya_stuff/From_server_ultralytic_compatible_ANN_SNN_event_based_to_slayer/checkpoints/SOTA_ANCHORFREE/GEN1_lava/gen1_lava_direct_sota_anchorfree.pt")

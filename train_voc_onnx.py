...
from obd.models import snn_repvgg_sota_onnx,snn_repvgg_onnx
...
class AnchorFreePredDecoder():
    ...
    def __init__(self,reg_max,num_classes,stride,device):
        ...
        self.dfl = snn_repvgg_onnx.SpikeDFL2(self.reg_max) if self.reg_max > 1 else nn.Identity()
...
def get_dataloader(mode="train", args = None,data = None,cfg = None,stridee = 32):
        ...
        dataset = YOLODataset(
                ...
                rect=False if mode == 'train' else False,  # rectangular batches, True for val and False for train
...
def main(args,default_cfg_file = "./default.yaml"):
    ...
    #net = lava_snn_model2_sota.CustomModel(in_channels=args.in_channels,num_classes=data_info['nc'],T=7,distillation_required = args.distill)
    ...
    net = snn_repvgg_onnx.CustomModel(in_channels=args.in_channels,num_classes=data_info['nc'],T=1,for_distillation = args.distill)
    ...
    # Input shape
    dummy_input = torch.randn(2 * 1,3, 224, 224)  # [B, C, H, W] or your actual model input

    # Export
    torch.onnx.export(
            net,
            dummy_input,
            "custom_model_voc.onnx",
            input_names=["input"],
            output_names=["output"],
...
def get_args():
    ...
    #parser.add_argument("-load",type=str,default="/home/nrthpc/Udaya_stuff/From_server_ultralytic_compatible_ANN_SNN_event_based_to_slayer/checkpoints/VOC_ckpts/lava/voc_lava_3.42quant_based_distilled/with_channel_distilled_0.29max/best.pt")
    #parser.add_argument("-load",type=str,default="/home/nrthpc/Udaya_stuff/From_server_ultralytic_compatible_ANN_SNN_event_based_to_slayer/checkpoints/SOTA_ANCHORFREE/VOC_lava/voc_lava_direct_sota_anchorfree.pt")
    #parser.add_argument("-load",type=str,default="/home/nrthpc/Udaya_stuff/Result_Collector/SOTA_Anchorfree_ann/voc/best.pt")
    parser.add_argument("-load",type=str,default="/home/nrthpc/Udaya_stuff/Result_Collector/snn_mini/voc/best2.pt")
    ...
    parser.add_argument('-data_yaml_file',type=str,default="./voc.yaml")      #"./voc.yaml")
    parser.add_argument('-result_csv_path',type=str,default="./results_img.csv") 
    parser.add_argument('-imgsz',type=int,default=224,help="reisized img size")
